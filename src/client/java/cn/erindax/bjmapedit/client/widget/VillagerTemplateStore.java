...
public final class VillagerTemplateStore {
	...
	public static boolean add(Entry entry) {
		...
		if (entry.name == null || entry.name.isBlank()) entry.name = "模板";
		normalize(entry);
	...
	private static void load() {
		...
		FOLDERS.clear();
		try {
			String json = TemplateFiles.read("villager_templates.json");
			if (json == null) return;
			...
			BjMapEdit.LOGGER.warn("Failed to load villager templates", e);
		}
	}
	...
	private static void save() {
		try {
			...
			TemplateFiles.write("villager_templates.json", GSON.toJson(data));
		} catch (Exception e) {
			BjMapEdit.LOGGER.warn("Failed to save villager templates", e);
		}
	}

	private static void normalize(Entry e) {
		if (e.keys == null) e.keys = new ArrayList<>();
		if (e.values == null) e.values = new ArrayList<>();
		if (e.trades == null) e.trades = new ArrayList<>();
		for (TradeData t : e.trades) {
			if (t == null) continue;
			if (t.buyId == null) t.buyId = "";
			if (t.buyCount == null) t.buyCount = "1";
			if (t.buyBId == null) t.buyBId = "";
			if (t.buyBCount == null) t.buyBCount = "1";
			if (t.sellId == null) t.sellId = "";
			if (t.sellCount == null) t.sellCount = "1";
			if (t.maxUses == null) t.maxUses = "16";
			if (t.buyTag == null) t.buyTag = "";
			if (t.buyBTag == null) t.buyBTag = "";
			if (t.sellTag == null) t.sellTag = "";
		}
	}
	...
	public static final class TradeData {
		...
		public String buyBCount = "1";
		public String sellId = "";
		public String sellCount = "1";
		public String maxUses = "16";
		public String buyTag = "";
		public String buyBTag = "";
	...
	public static final class Entry {
		...
		public List<TradeData> trades = new ArrayList<>();
	}
}
