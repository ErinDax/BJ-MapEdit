...
public final class ItemTemplateStore {
	...
	private static void load() {
		...
		FOLDERS.clear();
		try {
			String json = TemplateFiles.read("item_templates.json");
			if (json == null) return;
			...
			BjMapEdit.LOGGER.warn("Failed to load item templates", e);
		}
	}
	...
	private static void save() {
		try {
			...
			TemplateFiles.write("item_templates.json", GSON.toJson(data));
		} catch (Exception e) {
			BjMapEdit.LOGGER.warn("Failed to save item templates", e);
		}
	}
	...
	public static final class Entry {
		...
		public boolean hideEnch;
		public boolean hideAttr;
		public boolean hideUnbr;
